...
mkdir /mnt/mongodb
docker run --name mongodb -e MONGO_INITDB_ROOT_USERNAME=admin -e MONGO_INITDB_ROOT_PASSWORD=ABcd_1234 -v /mnt/mongodb:/data/db --network mongo-network -p 27017:27017 -itd mongo:latest
